...
public:
    ...
    TreeNode* buildTree(int preStart, int preEnd, int postStart, vector<int>& preorder, vector<int>& postorder){
        ...
        while(postorder[postStart+leftSubtreeSize-1] != leftSubtreeRoot){
            leftSubtreeSize++;
        }
